...
- Microcode update for CPUID signature `06-3d-04` (`0x0306D4`), pinning the exact microcode blob from the vetted coreboot/Intel microcode source used for the build
